  ...
  render() {
    this.element.innerHTML = ` <section class="pokemon">
          ...
          <div class= pokemon__buttons>
             <i class="minus"><img src="imagenes/minus.ico" alt="icono quitar" height="25" width"25"></i>
            <i class="plus"><img src="imagenes/plus.ico" alt="icono añadir"  height="25" width"25"></i>
          </div>
        </section>
